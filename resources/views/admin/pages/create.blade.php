    ...
    <div class="page-content">
		<div class="card">
            ...
            <div class="card-body">
                ...
                <form autocomplete="off" method="post" action="{{route('admin.catalog.page.store')}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea id="information-description" class="form-control @error('description') is-invalid @enderror" placeholder="Description" name="description">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input id="sort-order" type="number" class="form-control" name="sort_order" value="{{ old('sort_order') }}" placeholder="Order">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="file-wrapper">
                                ...
                                <input type="hidden" name="feature_image" value="" id="input-image-name-info" />
                                <!-- /add img -->
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12">
